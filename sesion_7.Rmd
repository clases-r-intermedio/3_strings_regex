...
(6). Une las bases **nac_region** y **proy_2017**, calcula la tasa bruta de natalidad (por 1.000 habitantes) por region $\frac{NacimientosEn La Región}{Proyección De Población En La Región}*100$ e imprime el resultado. Para unir las bases, puedes utilizar `left_join()` (**3 puntos**). 
